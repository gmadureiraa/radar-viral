...
/**
 * Twitter card image (summary_large_image). Mesma arte do OG —
 * inline (não re-export) porque o Turbopack não reconhece os campos de
 * config metadata re-exportados de outro arquivo.
 */
